                ...
                <div class="modal-body">
                    ...
                    <div class="actual-form">
                        <div class="form-group mb-3">
                            ...
                            <small class="text-danger d-none" id="error_new_grade_component_component">Component is already in use!</small>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <small class="text-danger d-none" id="error_new_grade_component_weight">The total weight of grade components exceeds 100%</small>
                        </div>
                    </div>
                </div>
